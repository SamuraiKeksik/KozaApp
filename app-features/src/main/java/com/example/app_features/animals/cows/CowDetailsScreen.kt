...
fun CowDetailsScreen(
    ...
    Column(
        ...
        CowDetailsBody(
            ...
            navigateToEditCow = navigateToEditCow,
...
@Composable
private fun CowDetailsBody(
    viewModel: CowDetailsViewModel,
    navigateToEditCow: (UUID) -> Unit,
    navigateToAddParent: (UUID, Gender) -> Unit,
    navigateToParentInfo: (UUID) -> Unit,
    navigateToChildren: (UUID) -> Unit,
    ...
    Column(
        ...
        CowDetailsComposable(
            cowDetails = uiState.cowDetails,
            onEditClick = { navigateToEditCow(uiState.cowDetails.id) },
        ...
        AnimalVaccinations(
            vaccinationsList = uiState.cowVaccinations,
        ...
        AnimalSicknesses(
            sicknessesList = uiState.cowSicknesses,
            sicknessTypesList = sicknessTypesList.sicknessTypesList,
            onAddClick = {
                viewModel.clearVaccinationUiState()
    ...
    if (uiState.cowDetails.gender == Gender.FEMALE){
        AnimalMilkYields(
            milkYieldsList = uiState.cowMilkYields,
            onAddClick = {
        ...
        if(canEdit) {
            OutlinedButton(
                ...
                Text(stringResource(R.string.cow_delete_button_label))
            }
        }
