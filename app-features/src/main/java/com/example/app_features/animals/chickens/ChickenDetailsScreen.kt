...
@Composable
fun ChickenDetailsScreen(
    navigateToEditChicken: (UUID) -> Unit,
    ...
    viewModel: ChickenDetailsViewModel = hiltViewModel()
) {
    Column(
        modifier = modifier,
    ) {
        ChickenDetailsBody(
            ...
            navigateToEditChicken = navigateToEditChicken,
...
@Composable
private fun ChickenDetailsBody(
    viewModel: ChickenDetailsViewModel,
    navigateToEditChicken: (UUID) -> Unit,
    navigateToAddParent: (UUID, Gender) -> Unit,
    navigateToParentInfo: (UUID) -> Unit,
    navigateToChildren: (UUID) -> Unit,
    ...
    Column(
        ...
        ChickenDetailsComposable(
            chickenDetails = uiState.chickenDetails,
            onEditClick = { navigateToEditChicken(uiState.chickenDetails.id) },
        ...
        AnimalVaccinations(
            vaccinationsList = uiState.chickenVaccinations,
        ...
        AnimalSicknesses(
            sicknessesList = uiState.chickenSicknesses,
            sicknessTypesList = sicknessTypesList.sicknessTypesList,
            onAddClick = {
                viewModel.clearVaccinationUiState()
        ...
        if(canEdit) {
            OutlinedButton(
                ...
                Text(stringResource(R.string.chicken_delete_button_label))
            }
        }
...
@Composable
fun ChickenDetailsScreenPreview() {
    AppTheme {
//        ChickenDetailsBody(
//            viewModel = ChickenDetailsViewModel(),
